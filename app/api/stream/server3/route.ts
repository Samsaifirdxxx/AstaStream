...
export async function GET(request: Request) {
  ...
  // Server 3 - Alternative streaming sources
...
<head>
  ...
  <title>Episode ${episode} - Server 3</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <script>
    (function() {
      ...
      // Multiple alternative streaming sources
      const streamSources = [
        'https://allanime.day/watch/${sanitizedTitle}/${episode}',
        'https://yugenanime.sx/watch/${animeId}/${episode}/',
        'https://animepahe.ru/play/${animeId}/${episode}',
        'https://anix.to/watch/${sanitizedTitle}?ep=${episode}',
        'https://animixplay.to/v1/${sanitizedTitle}/ep${episode}'
      ];
